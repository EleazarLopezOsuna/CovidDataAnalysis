...
class sixteenthItem():
    ...
    def __init__(self, continentColumn, continentName, countryColumn, countryName, regionColumn, regionName, infectedColumn, deathsColumn, dayColumn, predictionDay, data):
        ...
        self.data = data.dropna(subset=[continentColumn, countryColumn, regionColumn, infectedColumn, deathsColumn, deathsColumn, dayColumn])
    ...
    def dataFilter(self):
        ...
        if(self.regionColumn != '' and self.regionName != ''):
            isState = self.data[self.regionColumn] == self.regionName
    ...
    def generateJSON(self, labels, setValues, predictedValues, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        graphName = '"graphName": "Porcentaje de muertes frente al total de casos en ' + self.continentName + ' ' + self.countryName + ' ' + self.regionName + '", '
    ...
    def generateConclution(self, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        leftColumn += '\\nEl porcentaje predicho para la fecha ' + str(formatedDate) + ' es de ' + str(prediction * 100) + '% lo que significa que '
        leftColumn += 'de contraer el virus se tiene un probabilidad de ' + str(prediction * 100) + '% de morir, estos datos fueron '
        ...
        rightColumn += 'sobre el comportamiento de la tasa en ' + str(self.continentName + ' ' + self.countryName + ' ' + self.regionName) + '. El modelo tiene un coeficiente de determinacion de '
