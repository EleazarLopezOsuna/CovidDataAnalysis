...
class sixteenthItem():
    ...
    def __init__(self, continentColumn, continentName, countryColumn, countryName, regionColumn, regionName, infectedColumn, deathsColumn, dayColumn, data):
    ...
    def generateConclution(self, mse, r2, coef, intercept):
        ...
        leftColumn += 'fue de ' + str(coef) + '\\nEl error cuadratico medio (ECM) es de ' + str(mse * 100) + '% estos datos fueron '
