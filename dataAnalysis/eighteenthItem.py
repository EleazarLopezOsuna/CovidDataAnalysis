...
class eighteenthItem():
    ...
    def __init__(self, continentColumn, continentName, countryColumn, countryName, stateColumn, stateName, provinceColumn, provinceName, behaviourColumn, classColumn, infectedColumn, dayColumn, predictionDay, data):
    ...
    def generateConclution1(self, formatedDate, prediction1, mse1, r21, coef1, prediction2, mse2, r22, coef2, intercept1, intercept2):
        ...
        leftColumn += '\\nLa prediccion obtenida para la fecha ' + str(formatedDate) + ' es de ' + str(np.round(prediction1, 4)) + ' Lo que representa los casos definos por el comportamiento ' + str(self.behaviourColumn) + '. '
        ...
        leftColumn += '\\nLa prediccion obtenida para la fecha ' + str(formatedDate) + ' es de ' + str(np.round(prediction2, 4)) + ' Lo que representa los casos definos por la clasificacion ' + str(self.classColumn) + '.", '
