...
class sixthItem():
    ...
    def generateJSON(self, labels, setValues, predictedValues, mse, r2, coef, intercept):
        ...
        graphName = '"graphName": "Analisis del numero de muertes por coronavirus en ' + self.countryName + '", '
    ...
    def generateConclution(self, mse, r2, coef, intercept):
        ...
        rightColumn += 'sobre el comportamiento de las muertes en ' + str(self.countryName) + '. El modelo tiene un coeficiente de determinacion de '
