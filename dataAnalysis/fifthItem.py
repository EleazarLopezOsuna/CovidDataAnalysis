...
class fifthItem():
    ...
    def __init__(self, continentColumn, continentName, countryColumn, countryName, deathsColumn, dayColumn, predictionDay, data):
    ...
    def generateJSON(self, labels, setValues, predictedValues, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        graphName = '"graphName": "Predicción de mortalidad por COVID en ' + self.countryName + '", '
    ...
    def generateConclution(self, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        rightColumn += 'sobre el comportamiento de la taza de mortalidad en ' + str(self.countryName) + '. El modelo tiene un coeficiente de determinacion de '
