...
class fourteenthItem():

    def __init__(self, continentColumn, continentName, countryColumn, countryName, regionColumn, regionName, deathColumn, dayColumn, predictionDay, data):
        ...
        self.deathColumn = deathColumn
        self.dayColumn = dayColumn
        self.predictionDate = predictionDay
        self.data = data.dropna(subset=[continentColumn, countryColumn, regionColumn, deathColumn, dayColumn])
    ...
    def generateJSON(self, labels, setValues, predictedValues, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        graphName = '"graphName": "Muertes segun ' + self.continentName + ' ' + self.countryName + ' ' + self.regionName + '", '
    ...
    def generateConclution(self, formatedDate, prediction, mse, r2, coef, intercept):
        ...
        rightColumn += 'sobre el comportamiento de los muertos en ' + str(self.continentName + ' ' + self.countryName + ' ' + self.regionName) + '. El modelo tiene un coeficiente de determinacion de '
